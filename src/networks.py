...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=8):
        ...
        self.layer2 = self._make_layer(block, 16, num_blocks[0], stride=1)
        self.layer3 = self._make_layer(block, 16, num_blocks[0], stride=1)
        self.layer4 = self._make_layer(block, 32, num_blocks[1], stride=2)
        self.layer5 = self._make_layer(block, 32, num_blocks[1], stride=1)
        self.layer6 = self._make_layer(block, 32, num_blocks[1], stride=1)
        self.layer7 = self._make_layer(block, 64, num_blocks[2], stride=2)
        self.layer8 = self._make_layer(block, 64, num_blocks[2], stride=1)
        self.layer9 = self._make_layer(block, 64, num_blocks[2], stride=1)
