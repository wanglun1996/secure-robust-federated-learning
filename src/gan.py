...
class DCGAN(object):
    ...
    def init_model_optimizer(self, data_dim):
        ...
        self.G = models.__dict__['decoder_fl'](dim=data_dim, nc=self.args.nz)
        ...
        self.D = models.__dict__['discriminator_fl'](dim=1, nc=data_dim)
...
class WGAN(object):
    ...
    def init_model_optimizer(self, data_dim):
        ...
        self.D = models.__dict__['discriminator_wgan'](dim=1, nc=data_dim)
        self.D = torch.nn.DataParallel(self.D).cuda()
        self.optim_D = torch.optim.Adam(
                        self.D.module.parameters(),
                        lr=self.args.gan_lr,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--nz', default=100)
    parser.add_argument('--nc', default=50)
    parser.add_argument('--batch_size', default=10)
    parser.add_argument('--gan_lr', default=1e-5)
